...
public class EmpleadoJpaController implements Serializable {
    ...
    public void create(Empleado empleado) {
        ...
        try {
            ...
            em.persist(empleado);
            if (juego != null) {
                juego.getEmpleado().add(empleado);
    ...
    */
    ...
    public void edit(Empleado empleado) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (juegoOld != null && !juegoOld.equals(juegoNew)) {
                juegoOld.getEmpleado().remove(empleado);
                juegoOld = em.merge(juegoOld);
            }
            if (juegoNew != null && !juegoNew.equals(juegoOld)) {
                juegoNew.getEmpleado().add(empleado);
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            Juego juego = empleado.getJuego();
            if (juego != null) {
                juego.getEmpleado().remove(empleado);
                juego = em.merge(juego);
            }
            em.remove(empleado);
            em.getTransaction().commit();
