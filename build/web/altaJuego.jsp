<%-- 
    ...
    Created on : 12/12/2020, 22:49:42
    Author     : Diego
--%>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Dar de alta  juego</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                ...
                <form action="AltaJuego" method="POST">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <label for="horaInicio">Seleccionar  hora Inicio juego:</label>
                    ...
                    <div class="form-group">
                        ...
                        <label for="horaFin">Seleccionar  hora finalización juego:</label>
