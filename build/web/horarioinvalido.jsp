<%-- 
    Document   : horarioinvalido
    Created on : 20/12/2020, 11:55:09
    Author     : Diego
--%>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Horario inválido</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Horario inválido</li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
...
<div class="lockscreen-wrapper">
  ...
  <div class="help-block text-center">
    El horario seleccionado no está dentro de la franja horario del juego
  </div>
  <div class="text-center">
    <a href="CrearEntrada.jsp">Volver intentarlo ingresado horario correcto</a>
  </div>
