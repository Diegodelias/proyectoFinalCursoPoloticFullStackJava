<%-- 
    Document   : EditarJuegos
    Created on : 18/12/2020, 07:04:33
    Author     : Diego
--%>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Modificar juego</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid pb-3">
                         ...
                         <%@ page import ="Logica.Controladora, Logica.Horario,Logica.Juego,java.util.List,java.text.DateFormat,java.util.Date,java.text.SimpleDateFormat" %>
                ...
                <form action="EditarListaJuego" method="GET">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="nombreJuego"  value="<%=  juego.getNombreJuego() %>" >
                      <input type="hidden" name="txtid" value="<%= juego.getId() %>">
                     ...
                     <div class="form-group">
                         ...
                         <label for="horaInicioActual" >Hora inicio actual:</label>
                      <input type="text" name="horaInicioActual"  value="<%=  horainicio %>" >
                      ...
                      <div class="form-group">
                        ...
                        <label for="horaInicio">hora Inicio nueva:</label>
                   ...
                   <div class="form-group">
                         ...
                         <label for="horaInicioFinal" >Hora fin actual:</label>
                      <input type="text" name="horaInicioActual"  value="<%=   horariofin %>" >
                        ...
                        <label for="horaFin">hora finalización juego nueva:</label>
                        <input type="time" id="appt" name="horaFin">
