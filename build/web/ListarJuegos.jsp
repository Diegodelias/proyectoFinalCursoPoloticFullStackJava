<%-- 
    Document   : ListarJuegos.jsp
    Created on : 17/12/2020, 18:00:46
    Author     : Diego
--%>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Lista de Juegos </h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Lista de Juegos</li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
                        ...
                        <table class="table" name="tabla">
                          <thead class="thead-dark">
                            <tr>
                              ...
                              <th scope="col">Horario aperura</th>
                          ...
                          <tbody>
                                ...
                                List<Juego> listaJuegos = control.getListaJuegos();
                                        for (Juego jue:listaJuegos ){
                                                     ...
                                                     Horario horario = jue.getHorario();
                                                     
                                                     SimpleDateFormat formatter=new SimpleDateFormat("HH:mm");
                                                 
                                                     String horainicio=formatter.format(horario.getHora_inicio());
                                                      String horariofin=formatter.format(horario.getHora_fin());
                            ...
                            <tr>
                                      ...
                                      <th scope="row"><%= jue.getId()  %></th>
                                             ...
                                             <td><%= horariofin  %></td>
                                              ...
                                              <td><button onclick="location.href='EditarListaJuego?accion=editar&id=<%= jue.getId() %>'"   class="btn btn-outline-secondary "><i class="fas fa-pencil-alt" ></i></button>
                                              <button  onclick="location.href='EditarListaJuego?accion=eliminar&id=<%= jue.getId() %>'"   class="btn btn-outline-secondary"  o><i class="fas fa-trash"></i></button></td>
