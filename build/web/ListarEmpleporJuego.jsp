<%-- 
    Document   : ListarEmpleporJuego
    Created on : 19/12/2020, 20:36:55
    Author     : Diego
--%>
...
<!DOCTYPE html>
  ...
  <head>
    ...
    <title>Lista empleados por juego</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Listar empleados por juego</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Listar empleados pro juego</li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
                          ...
                          <thead class="thead-dark">
                            <tr>
                              ...
                              <th scope="col">Telefono</th>
                               <th scope="col">NombreJuego</th>
                              
                            </tr>
                          </thead>
                          <tbody>
                                <%@ page import ="Logica.Controladora, Logica.Cliente, Logica.Juego, Logica.Empleado ,java.util.List" %>
                                                       ...
                                                       <% List <Empleado> listaEmpleados =  
                                                        (List<Empleado>)request.getAttribute("listaFinal"); 
                                                       
                                                         for(Empleado e:listaEmpleados){
                                                       
                                                             Juego juegotemp = e.getJuego();
