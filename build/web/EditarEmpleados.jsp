<%-- 
    ...
    Created on : 14/12/2020, 22:45:30
    Author     : Diego
--%>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Editar  empleados y usuarios</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid pb-3">
                  ...
                  <%@ page import ="Logica.Controladora,Logica.Usuario, Logica.Empleado,Logica.Juego,java.util.List" %>
                ...
                <%
                 Controladora ctrl = new Controladora();
                  ...
                  int idemp = Integer.parseInt((String) request.getAttribute("idEmp"));
                  
                   Empleado e = ctrl.TaerEmpleadoEnParticular(idemp);
                
                 Usuario usutemp = e.getUser();
                ...
                <form action="EditarEmpleado" method="GET">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="Ingrese nombre" name="nombre" value="<%= e.getNombre() %>">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="Ingrese apellido" name="apellido" value="<%= e.getApellido()%>">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="dni" name="dni" value=" <%= e.getDni()%>">
                        ...
                        <input type="text" class="form-control"  placeholder="mombre de usuario" name="usuario" value="<%= usutemp.getNombreUsuario()%>">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control"  placeholder="contraseña" name="password" value="<%= usutemp.getContrasenia()%>">
                     ...
                     <div class="form-group">
                             <label class="mr-sm-2" for="juegoAsignado">Juego asignado</label>
                                <select class="custom-select mr-sm-2"  name="juegoAsignado" value="">
                                <option selected value="<%= juego.getId()%>">Seleccionar Juego...</option>
                    ...
                    <button type="submit" class="btn btn-primary" name="accion" value="Actualizar">Enviar</button>
                </form>
