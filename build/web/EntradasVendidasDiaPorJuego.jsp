<%-- 
    Document   : EntradasVendidasDiaPorJuego
    Created on : 20/12/2020, 09:31:00
    Author     : Diego
--%>
...
<html lang="en">
  <head>
    ...
    <title>Entrads vendidas por dia por juego</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Cantidad entradas vendidas en día determinado (por juego)</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Dar de alta  juego</li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="EntradasVendidasDiaPorJuego" method="POST">
                     ...
                     <div class="form-group">
                             <label class="mr-sm-2" for="juegoAsignado">Juego asignado</label>
                                ...
                                <option selected>Elegir juego...</option>
