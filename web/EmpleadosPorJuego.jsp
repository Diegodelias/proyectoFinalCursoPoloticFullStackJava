<%-- 
    Document   : EmpleadosPorJuego
    Created on : 19/12/2020, 20:21:20
    Author     : Diego
--%>
...
<!DOCTYPE html>
 ...
 <html lang="en">
  <head>
    ...
    <title>Empleados por Juego</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid pb-3">
                ...
                <form action="EmpleadosPorJuego" method="POST">
                     ...
                     <div class="form-group">
                             ...
                             <%       
                                ...
                                List<Juego> listaJuego = controladora.getListaJuegos();
