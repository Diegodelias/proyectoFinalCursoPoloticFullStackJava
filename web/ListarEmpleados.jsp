<%-- 
    ...
    Created on : 14/12/2020, 17:24:14
    Author     : Diego
--%>
                        ...
                        <table class="table" name="tabla">
                          <thead class="thead-dark">
                            <tr>
                              ...
                              <th scope="col">Juego en que trabaja</th>
                          ...
                          <tbody>
                                <%@ page import ="Logica.Controladora, Logica.Empleado, Logica.Juego ,java.util.List" %>
                                   ...
                                   <% 
                                 Controladora control =  new Controladora();
                                List<Empleado> listaEmpleado = control.getListaEmpleados();
                                        for (Empleado emple:listaEmpleado ){
                                            
                                                     Juego juegoTemp = emple.getJuego();
                            ...
                            <tr>
                                      ...
                                      <th scope="row"><%= emple.getId()  %></th>
                                             <td><%= emple.getNombre()  %></td>
                                             <td><%= emple.getApellido()  %></td>
                                             
                                            
                                             
                                             <td><%= juegoTemp.getNombreJuego()   %></td>
                                              <td><%= emple.getTelefono()  %></td>
                                              <td><button onclick="location.href='EditarEmpleado?accion=editar&id=<%= emple.getId() %>'"   class="btn btn-outline-secondary "><i class="fas fa-pencil-alt" ></i></button>
                                              <button  onclick="location.href='EditarEmpleado?accion=eliminar&id=<%= emple.getId() %>'"   class="btn btn-outline-secondary"  o><i class="fas fa-trash"></i></button></td>
