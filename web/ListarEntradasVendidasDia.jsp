<%-- 
    Document   : ListarEntrdasVendidasDia
    Created on : 20/12/2020, 08:54:19
    Author     : Diego
--%>
...
<!DOCTYPE html>
  ...
  <head>
    ...
    <title>Listado Entradas vendidas por dia</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Cantidad entradas vendidas en día determinado</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Entradas vendidas en un determinado día ( todos los juegos)</li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
                            ...
                            <tr>
                              ...
                              <th scope="col">Nombre del juego</th>
                               <th scope="col">Horario</th>
                                  <th scope="col">Total entradas vendidas</th>
                              
                            </tr>
                          </thead>
                          <tbody>
                                <%@ page import ="Logica.Controladora, Logica.Cliente, Logica.Juego,Logica.Horario, Logica.Entrada ,java.util.List, java.util.List, java.text.DateFormat,java.util.Date,java.text.SimpleDateFormat" %>
                                                       ...
                                                       <%
                                                        ...
                                                        (List<Entrada>)request.getAttribute("listaFinalvendidasdia"); 
                            ...
                            <tr>
                                             ...
                                             <td><%= e.getNombre_cliente()  %></td>
                                             <td><%= e.getApellido_Cliente()  %></td>
                                                                                          <td><%= fecha  %></td>
                            ...
                            <tr>
                                    ...
                                    <th scope="row"></th>
                                         ...
                                         <td><%= listaEntradas.size() %> entrada(s) vendida(s) </td>
