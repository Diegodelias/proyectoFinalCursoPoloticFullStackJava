<%-- 
    Document   : ListarEntradas
    Created on : 20/12/2020, 16:48:54
    Author     : Diego
--%>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Listado entradas vendidas</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Listado entradas vendidas</li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
        ...
        <section class="content">
            <div class="container-fluid pb-3">
                      ...
                      <table class="table" name="tabla">
                          ...
                          <tbody>
                                <%@ page import ="Logica.Controladora, Logica.Empleado,Logica.Entrada,Logica.Horario, Logica.Juego ,java.util.List, java.text.DateFormat,java.util.Date,java.text.SimpleDateFormat" %>
                                ...
                                List<Entrada> listaEntradas = control.getListaEntradas();
                                      ...
                                      Long  id = ent.getJuego().getId();
                                      
                                     /* out.println("horrible id " + id);*/
                                      
                                      Juego juego = new Juego();
                                      
                                  /*    if (id != null){*/
                                          
                                         /* long id_juego = Long.parseLong(id);*/
                                          
                                          juego = control.TaerJuegoEnParticular(Long.valueOf(id)); 
                                          System.out.println( "vacioo papa" );
                                          ...
                                          String fecha = formatter2.format(ent.getFecha());
                                       
                                          /*  out.println(horainicio);*/
                                 ...
                                 /*    juego = control.TaerJuegoEnParticular(Long.valueOf(3)); */
                              ...
                              /**    hardcodeado así anda       Juego juego = control.TaerJuegoEnParticular(Long.valueOf(3));    **/
                            ...
                            <tr>
                                      ...
                                      <th scope="row"><%= ent.getId()  %></th>
                                             <td><%= ent.getNombre_cliente()  %></td>
                                             <td><%= ent.getApellido_Cliente()  %></td>
                                             <td><%= fecha  %></td>
                                              <td><%= juego.getNombreJuego()  %></td>
                                              <td><%= horainicio %> -  <%=horariofin%></td>
                                              ...
                                              <td>
                                              <button  onclick="location.href='CrudEntradas?accion=eliminar&id=<%= ent.getId() %>'"   class="btn btn-outline-secondary"  o><i class="fas fa-trash"></i></button></td>
