<%-- 
    Document   : CrearEntrada.jsp
    Created on : 16/12/2020, 00:00:23
    Author     : Diego
--%>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Crear Entrada</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Crear Entrada</li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
        ...
        <section class="content">
            <div class="container-fluid pb-3">
                ...
                <form action="CrudEntradas" method="POST">
                    
                                         
                     <div class="form-group">
                             <label class="mr-sm-2" for="juegoAsignado">Seleccionar cliente </label>
                                <select class="custom-select mr-sm-2"  name="cliente" required>
                                <option selected>Seleccionar Juego...</option>
                                
                                <%@ page import ="Logica.Controladora, Logica.Cliente,java.util.List" %>
                      ...
                      <div class="form-group">
                        ...
                        <label for="horaInicio"  name="hora">Seleccionar  hora :</label>
                     ...
                     <div class="form-group">
                             <label class="mr-sm-2" for="juegoAsignado">Seleccionar Juego </label>
                             <select class="custom-select mr-sm-2"   name="juegoelegido" >
                                <option selected>Seleccionar Juego...</option>
