<%-- 
    ...
    Created on : 15/12/2020, 22:12:46
    Author     : Diego
--%>
        ...
        <section class="content">
            <div class="container-fluid pb-3">
                        ...
                        <table class="table" name="tabla">
                          ...
                          <tbody>
                                <%@ page import ="Logica.Controladora, Logica.Cliente, Logica.Juego ,java.util.List" %>
                                
                                <% 
                                 Controladora control =  new Controladora();
                                List<Cliente> listaCliente = control.getListaClientes();
                            ...
                            <tr>
                                             ...
                                             <td><%= cli.getApellido()  %></td>
                                              ...
                                              <td>
                                              <button  onclick="location.href='CrudCliente?accion=eliminar&id=<%= cli.getId()  %>'"   class="btn btn-outline-secondary"  ><i class="fas fa-trash"></i></button></td>
