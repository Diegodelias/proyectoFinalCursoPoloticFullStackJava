<%-- 
    Document   : ListaEntradasDiaPorJuego
    Created on : 20/12/2020, 10:15:08
    Author     : Diego
--%>
...
<!DOCTYPE html>
 <html lang="en">
  <head>
    ...
    <title>Lista de entradas por dia juego</title>
                          ...
                          <tbody>
                                <%@ page import ="Logica.Controladora, Logica.Cliente, Logica.Juego,Logica.Horario, Logica.Entrada ,java.util.List, java.util.List, java.text.DateFormat,java.util.Date,java.text.SimpleDateFormat" %>
                                                       ...
                                                       <%
                                                        ...
                                                        (List<Entrada>)request.getAttribute("listaFinalpordia"); 
